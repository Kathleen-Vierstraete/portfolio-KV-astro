...
const HeroEnglish = () => (
  <Section>
    <HeroAvatar
      ...
      description={
        <>
          I am a Fullstack developer, with a preference for the BackEnd. I am
          also a multimedia content creator. Feel free to discover my projects,
          developed on my own or with teammates. I am available for new
          adventures full of code and challenges. You can contact me via email :{' '}
    ...
    <HeroAvatar
      ...
      socialButtons={
        <div className="mt-5">
          <h3 className="mb-4 text-lg font-semibold text-gray-400">
            My Suite Adobe and Office Pack skills:
          </h3>
